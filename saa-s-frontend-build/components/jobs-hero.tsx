  ...
  return (
    <section className="relative overflow-hidden bg-gray-100 pt-32 pb-20 text-gray-950 lg:pt-40 lg:pb-28">
      ...
      <div className="relative mx-auto w-full max-w-[1600px] px-5 text-center lg:px-8">
        ...
        >
          Open{" "}
          <span className="text-[var(--accent-glow)]">Positions</span>
        </motion.h1>
        ...
        >
          Browse live opportunities in trucking, warehousing, general labour and
          office roles. Find the right fit and apply in minutes.
        </motion.p>
