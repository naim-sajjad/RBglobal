      ...
      <div className="relative z-10 flex flex-col items-center justify-center min-h-screen px-4 py-16">
        ...
        <div className="w-full max-w-md">
          ...
          <div className="bg-[#D4AF37] rounded-t-2xl px-8 py-6 text-center">
            <h1 className="text-2xl md:text-3xl font-bold text-[#111827] uppercase tracking-wide">
              Register Account
            </h1>
          </div>
          ...
          <div className="bg-white rounded-b-2xl shadow-2xl shadow-black/30 px-8 py-10">
            ...
            <div className="flex items-center justify-center mb-8">
              <div className="flex bg-gray-100 rounded-full p-1 border-2 border-[#111827]/10">
                <button
                  type="button"
                  onClick={() => setActiveTab("candidate")}
                  className={`px-8 py-3 rounded-full text-sm font-bold uppercase tracking-wider transition-all duration-300 ${
                    activeTab === "candidate"
                      ? "bg-white text-[#111827] shadow-md border-2 border-[#111827]/20"
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  <Mail className="absolute left-4 top-1/2 -translate-y-1/2 w-5 h-5 text-[#3B82F6]" />
                  <Input
                    id="email"
                    type="email"
              ...
              <p className="text-sm text-gray-500 text-center leading-relaxed">
                {"By hitting the "}
                <span className="font-bold text-[#111827]">{'"Register"'}</span>
                {" button, you agree to the "}
                <Link href="#" className="text-[#3B82F6] hover:text-[#D4AF37] font-medium transition-colors">
                  Terms conditions
                </Link>
                {" and "}
                <Link href="#" className="text-[#3B82F6] hover:text-[#D4AF37] font-medium transition-colors">
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <button
                type="button"
                className="flex items-center gap-3 bg-[#1DA1F2] hover:bg-[#0d8ddb] text-white font-semibold py-3.5 px-5 rounded-xl transition-all duration-300 hover:scale-[1.02]"
              >
