  ...
  return (
    <section className="relative overflow-hidden bg-gray-100 pt-32 pb-20 text-gray-950 lg:pt-40 lg:pb-28">
      ...
      <div className="relative mx-auto w-full max-w-[1600px] px-5 text-center lg:px-8">
        ...
        >
          Stay Ahead With{" "}
          <span className="text-[var(--accent-glow)]">Expert Knowledge</span>
        </motion.h1>
        ...
        >
          From resume building to essential interview tips and industry trends, we
          share the tools you need to stand out and land your dream job.
        </motion.p>
      </div>
    </section>
  )
