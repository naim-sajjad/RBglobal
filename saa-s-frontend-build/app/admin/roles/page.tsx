    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-slate-400 mt-2">Manage roles and their permissions</p>
        </div>
              ...
              <div className="space-y-3">
                ...
                <div className="border border-slate-600 rounded-lg p-3 space-y-2 bg-slate-700/50">
                  {permissions.length === 0 ? (
                    <p className="text-slate-400 text-sm">No permissions available</p>
                  ) : (
                ...
                <TableBody>
                  {roles.map((role) => (
                    ...
                    >
                      ...
                      <TableCell>
                        <div className="flex flex-wrap gap-1">
                          {role.permissions.slice(0, 2).map((perm) => (
                            <Badge key={perm.id} variant="secondary" className="bg-slate-600 text-xs">
                              {perm.name}
                            </Badge>
                          ))}
                      ...
                      <TableCell className="text-slate-300 text-sm">{role.tenant_id}</TableCell>
