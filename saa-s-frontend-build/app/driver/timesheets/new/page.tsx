    ...
    <div className="p-6 max-w-lg mx-auto">
      ...
      <Card className="bg-slate-800 border-slate-700">
        <CardHeader>
          ...
          <CardDescription className="text-slate-400">Choose the week for this timesheet. You can add trips and pay items after creating it.</CardDescription>
        </CardHeader>
        <CardContent>
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="space-y-2">
                <Label htmlFor="week_start_date" className="text-slate-300">Week start date</Label>
                <Input
                  id="week_start_date"
                  type="date"
                  value={weekStartDate}
              ...
              <div className="space-y-2">
                <Label htmlFor="week_end_date" className="text-slate-300">Week end date</Label>
                <Input
                  id="week_end_date"
                  type="date"
                  value={weekEndDate}
            ...
            <div className="flex gap-2 pt-2">
              ...
              <Button type="button" variant="outline" asChild className="border-slate-600 text-slate-300">
